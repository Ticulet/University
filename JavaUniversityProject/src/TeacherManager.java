...
public class TeacherManager extends Frame implements ActionListener {
    ...
    private void addTeacher() {
        ...
        if (highSchoolRadio.getState()) {
            ...
            int experience = parseFieldToInt(experienceField.getText(), "Years of experience");
            if (experience == -1) return;
            String grade = gradeField.getText();
            int nrOfHours = parseFieldToInt(nrOfHoursField.getText(), "number of hours");
        ...
        // Check if the college radio button is selected
            ...
            int yearOfEmployment = parseFieldToInt(yearOfEmploymentField.getText(), "Year of employment");
     ...
     */
    private int parseFieldToInt(String fieldValue, String fieldName) {
