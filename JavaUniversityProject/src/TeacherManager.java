...
public class TeacherManager extends Frame implements ActionListener {
    ...
    private void modifyTeacher() {
        ...
        if (selectedIndex != -1) {
            ...
            if (teacher instanceof HighSchoolTeacher) {
                ...
                addDialog.setTitle("Modifying High School Teacher");
                ...
                addDialog.setTitle("Modifying College Teacher");
                addDialog.setVisible(true);
            }
        }
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            ...
            // Clear the selection in the teacherList
            teacherList.deselect(teacherList.getSelectedIndex());
